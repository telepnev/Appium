...
public class SearchPageObject extends MainPageObject {
    ...
    public void waitForCancelButtonToAppear() {
        this.waitForElementPresent(By.id(SEARCH_CANCEL_BUTTON), "Cannot click cancel button", 5);
    }
    public void waitForCancelButtonToDisAppear() {
        this.waitForElementNotPresent(By.id(SEARCH_CANCEL_BUTTON), "Search button still present", 5);
    }
