...
public class SearchPageObject extends MainPageObject {
    ...
    private static final String
            ...
            SAERCH_CANCEL_BUTTON = "org.wikipedia:id/search_close_btn",
    ...
    public void waitForCancelButtonToAppear() {
        this.waitForElementPresent(By.id(SAERCH_CANCEL_BUTTON), "Cannot find cancel button", 5);
    }

    public void waitForCancelButtonToDisAppear() {
        this.waitForElementNotPresent(By.id(SAERCH_CANCEL_BUTTON), "Search button still present", 5);
    }

    public void clickCancelSearch() {
        this.waitForElementAndClick(By.id(SAERCH_CANCEL_BUTTON), "Cannot click the Cancel button", 5);
    }
